...
XCELlesson.getContext = function (parentActivityId, isAssessment) {
  isAssessment = typeof isAssessment !== "undefined" ? isAssessment : false;
  var ctx = {
    contextActivities: {
      grouping: [
        {
          id: XCELlesson.CourseActivity.id,
        },
        {
      ...
      category: [
        ...
        },
        {
          ...
          definition: {
            ...
            description: {
              "en-US":
                "An e-learning course built using the golf prototype framework.",
            },
          },
        },
      ],
  ...
  if (isAssessment) {
    ctx.contextActivities.grouping.push({
      id: XCELlesson.CourseActivity.id + "/GolfAssessment",
    });
  }
  return ctx;
};
